...
(defn hitch-node
  ([graph selector-constructor] (hitch-sel graph (selector-constructor)))
  ([graph selector-constructor a] (hitch-sel graph (selector-constructor a)))
  ([graph selector-constructor a b] (hitch-sel graph (selector-constructor a b)))
  ([graph selector-constructor a b c] (hitch-sel graph (selector-constructor a b c)))
  ([graph selector-constructor a b c d] (hitch-sel graph (selector-constructor a b c d)))
  ([graph selector-constructor a b c d f] (hitch-sel graph (selector-constructor a b c d f)))
  ([graph selector-constructor a b c d f g] (hitch-sel graph (selector-constructor a b c d f g)))
  ([graph selector-constructor a b c d f g h] (hitch-sel graph (selector-constructor a b c d f g h))))
